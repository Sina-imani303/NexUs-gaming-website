            ...
            <div>
              ...
              <div className="relative mb-4">
                ...
                <input
                  ...
                  className="h-12 w-full rounded-2xl border border-border bg-background-secondary pr-11 pl-4 text-sm outline-none transition placeholder:text-muted focus:border-primary"
                />
              </div>
                ...
                {filteredFriends.map((friend) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <span
                        className={`flex h-7 w-7 shrink-0 items-center justify-center rounded-full border ${selected ? "border-primary bg-primary text-background" : "border-border text-transparent"}`}
                      >
